...
function CartItem({name, type, size, totalPrice, totalCount, removeItem, id, onPlus, onMinus}) {
    ...
    return (
        ...
        <div className="cart__item-info">
          <h3>{name}</h3>
          <p>тесто {type}, {size} см.</p>
        </div>
        <div className="cart__item-count">
          <div className="button button--outline button--circle cart__item-count-minus">
            <svg onClick={onMinusCartItem}
        ...
        <div className="cart__item-remove">
          <Button  onClick={onremoveCartItem} className="button--circle" outline>
