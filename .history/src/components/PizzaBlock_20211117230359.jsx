...
function PizzaBlock({id, name, imageUrl, price, sizes, types, onClickAddPizza}) {
  ...
  const handleAddPizza =()=>{
    const obj ={
      ...
      imageUrl,
      price: amout,
      size: avaibleSizes[chooseSize],
      type: avaibleTypes[chooseTypes],
    }
    onClickAddPizza(obj)
  }
  const handleSelectSize = (index) =>{
    setChooseSize(index)
    setAmout(price + arrSizePrice[index])
  ...
  const handleSelectTypes = (index) =>{
    ...
    return (
        ...
        <div className="pizza-block__bottom">
          <div className="pizza-block__price">{amout} ₽</div>
