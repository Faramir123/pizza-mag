...
function PizzaBlock({name, imageUrl, price, sizes, types}) {
  ...
  const calcSumm = () =>{
    if(chooseTypes === 0 && chooseSize === 1){
      price += 300 + 120
    }else if (chooseTypes === 1 && chooseSize === 2){
      return price+=260 +120
    }
    if (chooseTypes === 1 && chooseSize === 1){
      price += 300 + 120
    }else if (chooseTypes === 1 && chooseSize === 2){
      return price+=260 +120
    }
  return price
    ...
    return (
        ...
        <div className="pizza-block__bottom">
          <div className="pizza-block__price">от { calcSumm() } ₽</div>
